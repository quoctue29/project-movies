...
// import { postUser } from "../../storeToolkit/quanLyNguoiDung/quanLyNguoiDungReducer";
import { useQuanLyNguoiDung } from "../../storeToolkit/quanLyNguoiDung/quanLyNguoiDungSelector";
...
const Login = () => {
  ...
  // useEffect(() => {
  //   dispatch(postUser({ taiKhoan: "", matKhau: "" }));
  // }, []);

  const onSubmitHandle = async (data) => {
    const res = await quanLyNguoiDungServices.postUser({
      taiKhoan: data.taikhoan,
      matKhau: data.matkhau,
    });
    console.log(res);
    // dispatch(postUser({ taiKhoan: data.taikhoan, matKhau: data.matkhau }));
  };
